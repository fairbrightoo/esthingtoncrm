...
export const SaleController = {
    ...
    createSale: async (req: Request, res: Response) => {
        try {
            ...
            let marketerCommissionRate = 10.0;
            let referrerId = null;
            ...
            if (resolvedMarketerId) {
                ...
                if (marketerInfo) {
                    marketerCommissionRate = marketerInfo.commissionRate || 10.0;
            ...
            const sale = await prisma.sale.create({
                data: {
                    ...
                    salutationOnDocument: salutationOnDocument ? String(salutationOnDocument) : null,
    ...
    recordPayment: async (req: Request, res: Response) => {
        try {
            ...
            if (loanAmount > 0) {
                const commissionRate = sale.marketerCommissionRate || sale.lead.assignedToUser?.commissionRate || 10.0;
