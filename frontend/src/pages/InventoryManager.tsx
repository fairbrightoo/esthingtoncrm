...
import { Plus, Edit2, Trash2, Home, MapPin, ArrowLeft, CheckSquare, Square, Save, Activity, RefreshCw, FileText } from 'lucide-react';
            ...
            complete: async (results) => {
                try {
                    ...
                    for (const row of results.data as any[]) {
                        ...
                        const date = row.Date || row.date || row['Original Date of Sale'] || row.originalDateOfSale;
                                        ...
                                        <div className="bg-white/60 p-6 rounded-xl border border-indigo-100/50">
                                            <div className="flex flex-col items-center justify-center border-2 border-dashed border-indigo-200/60 rounded-xl p-8 bg-indigo-50/30 transition hover:bg-indigo-50/50 group">
                                                ...
                                                <p className="text-[11px] text-indigo-900/60 text-center mb-4 max-w-md">
                                                    ...
                                                    <br/>
                                                    <span className="opacity-80">Google Forms 'Timestamp' columns are automatically ignored. Dates can be in any standard format (e.g., YYYY-MM-DD, MM/DD/YYYY).</span>
                                                </p>
                                                <input 
                                                    type="file" 
                                                    accept=".csv"
