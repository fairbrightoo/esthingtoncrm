    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <div ref={reportRef} className="space-y-6 print:p-8 print:bg-white print:min-h-screen">
                ...
                {/* Main Profit Banner */}
                <div className="bg-gradient-to-br from-green-900 to-green-700 rounded-2xl shadow-lg p-6 md:p-8 flex flex-col md:flex-row items-center justify-between text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-10 opacity-10">
                        <Activity size={180} />
                    </div>
                    <div className="relative z-10 w-full">
                        <p className="text-green-100 font-semibold tracking-widest uppercase text-sm mb-2 opacity-90">Net Branch Profit / Loss</p>
                        <h2 className="text-4xl md:text-5xl font-black tracking-tight">
                            ₦{(stats.kpis?.netBranchProfit || 0).toLocaleString()}
                        </h2>
                        <div className="mt-4 flex items-center space-x-6 text-sm font-medium opacity-90">
                            <div><span className="opacity-75">Gross Revenue:</span> ₦{(stats.kpis?.grossRevenue || 0).toLocaleString()}</div>
