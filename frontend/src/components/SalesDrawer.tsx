                        ...
                        <div className="bg-orange-50 border border-orange-100 p-3 rounded-lg">
                            <label className="block text-sm font-medium text-orange-800 mb-1 flex items-center justify-between">
                                ...
                                <span className="text-xs bg-orange-200 text-orange-900 px-2 py-0.5 rounded-full font-bold">
                                    Max: ₦{((Number(paymentAmount) || 0) * ((sale?.marketerCommissionRate || sale?.marketer?.commissionRate || sale?.lead?.assignedToUser?.commissionRate || 5) / 100)).toLocaleString()}
                                </span>
                            </label>
                            <input
                                type="number"
                                max={(Number(paymentAmount) || 0) * ((sale?.marketerCommissionRate || sale?.marketer?.commissionRate || sale?.lead?.assignedToUser?.commissionRate || 5) / 100)}
